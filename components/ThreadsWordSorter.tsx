    ...
    return (
      <main className="mx-auto max-w-5xl px-4 py-8">
        <section className="mb-4 rounded-2xl border bg-white shadow-sm">
          ...
          >
            <h1 className="text-xl font-bold">Threads 貼文比較</h1>
        ...
        <section className="mx-auto grid max-w-5xl grid-cols-1 gap-4 md:grid-cols-[420px_48px_420px] md:items-center md:justify-center md:gap-5">
          <button
            type="button"
            onClick={() => handleChoose("left")}
            className="group flex h-[260px] w-full flex-col rounded-2xl border-2 border-gray-200 bg-white p-4 text-left shadow-sm transition hover:-translate-y-1 hover:border-blue-500 hover:shadow-lg md:p-6"
          >
            <div className="h-[150px] overflow-y-auto whitespace-pre-wrap text-sm leading-7 text-gray-900 md:text-base md:leading-8">
              {currentPair.left.content}
            </div>

            <div className="mt-auto rounded-xl bg-gray-50 p-3 text-center text-sm font-semibold text-gray-500 group-hover:bg-blue-50 group-hover:text-blue-600">
              選這篇
            </div>
          </button>
